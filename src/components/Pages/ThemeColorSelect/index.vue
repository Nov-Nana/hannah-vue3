<template>
    <n-button quaternary title="颜色" @click="modelShow = true">
            ...
            <div class="model-content" ref="contentLeftRef">
                ...
                <div class="content-right">
                    <div class="color-name-detail">
                        ...
                        <n-text v-if="appThemeDetail" class="color-name-Pinyin">{{ appThemeDetail.pinyin.toUpperCase()
                        }}</n-text>
                        <div v-if="appThemeDetail" class="select-color" :style="{ backgroundColor: designStore.appTheme }">
                        </div>
                    </div>
