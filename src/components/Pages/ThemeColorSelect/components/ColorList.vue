<template>
    <div class="content-left">
        <div class="content-left-item go-transition-quick go-mb-0" v-for="(item) in designColorRecommend" :key="item.hex"
        ...
        <n-divider></n-divider>
        <div class="content-left-item go-transition-quick" v-for="(item) in designColor" :key="item.hex"
            @click="colorSelectHandle(item)">
            <n-space>
                <div class="content-left-item-color" :style="{ backgroundColor: item.hex }"></div>
                <n-space vertical>
