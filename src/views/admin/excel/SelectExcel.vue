<template>
    <div class="select-excel-container">
        <n-grid :x-gap="24" :y-gap="24" cols="8 s:8 m:8 l:8 xl:8 2xl:8" responsive="screen">
            <n-grid-item :span="6">
            ...
            <n-grid-item :span="2">
                <n-button size="small" type="primary" :loading="downloadLoading" @click="handleDownload">
                    ...
                    {{ t('admin.select_excel') }}
                </n-button>
            </n-grid-item>
        </n-grid>
        <div class="space"></div>
        <LinTable :select="true" :columns="columns" @updateSelect="filterSelect"></LinTable>
    </div>
</template>
